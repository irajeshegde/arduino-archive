...
void loop() // run over and over
{
  ...
  if (g == 1)
  {
    if (number == "+919481801348" && content == "light on")
    {
    ...
    if (number == "+919481801348" && content == "light off")
    {
      digitalWrite(13, LOW);
    ...
    if (number == "+919481801348" && content == "pump on")
    {
    ...
    if (number == "+919481801348" && content == "pump off")
    {
    ...
    if (number == "+919481801348" && content == "fan on")
    {
    ...
    if (number == "+919481801348" && content == "fan off")
    {
    ...
    if (number != "+919481801348" && (content == "fan off" || content == "fan on" || content == "pump off" || content == "pump on" || content == "light off" || content == "light on"))
    {
      mySerial.print("AT+CMGF=1");
      delay(100);
      mySerial.write(0x0d);
      delay(100);
      mySerial.println("AT+CMGS=\"+919481801348\"\r");
      delay(1000);
...
// +CMT: "+919481801348",,"16/10/29,18:28:49+22"
//  Fds
